...
<form class="form-horizontal" id="addArticleForm" action="rest/cms/addArticle" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" id="title" name="title" placeholder="Title(30字以内)">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-md-5 col-lg-9" style="width: 90%;">
            <textarea class="form-control" id="contents" name="content" aria-required="true" style="width: 90%;height: 500px;"></textarea>
        </div>
    </div>
