    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" id="page-sidebar-menu">
                ...
                <c:forEach var="menus" items="${userInfo.menus}">
                    <c:if test="${menus.parentid == null }">
                        <li class="">
                            <a href="javascript:;">
                                <i class="${menus.icon}"></i><span class="title"> ${menus.name} </span><span class="arrow "> </span>
                            </a>
                            <ul class="sub-menu">
                                <c:forEach items="${userInfo.menus }" var="secondMenu">
                                    <c:if test="${secondMenu.parentid == menus.id }">
                                        <li>
                                            <a href="${basePath }${secondMenu.url }">${secondMenu.name }</a>
                                        </li>
                                    </c:if>
                                </c:forEach>
                            </ul>
                ...
                <%--                       <li class="">
                                           ...
                                           <c:if test="${userInfo.menus!=null }">
                                               <ul class="sub-menu">
                                                   <c:forEach items="${userInfo.menus }" var="menu">
                                                       <li>
                                                           <a href="${basePath }${menu.url }">${menu.name }</a>
                                                       </li>
                                                   </c:forEach>
                                               </ul>
                                           </c:if>
               ...
               &lt;%&ndash;                            <ul class="sub-menu">
                                               <li>
                                                   <a href="rest/page/echart">
                                                       可视化
                                                   </a>
                                               </li>
                                               <li>
                                                   <a href="rest/page/test">
                                                       角色管理
                                                   </a>
                                               </li>
                                               <li>
                ...
                <li class="">
                    <a href="javascript:;">
                        <i class="fa fa-compass"></i><span class="title"> 权限测试 </span><span
                            class="arrow "> </span>
                    </a>
                    <ul class="sub-menu">
...
<script src="hemi/js/index.js"></script>
<script>
